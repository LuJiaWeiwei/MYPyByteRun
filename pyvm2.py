...
class VirtualMachine(object):
    ...
    '''The following is functions managing data_stack'''
    def top(self):
    ...
    '''When generating a frame, change the environment, and print out the prompt
    message'''
    ...
    '''The following is functions managing frame_stack'''
    ...
    '''When a frame there are part still not running out'''
    ...
    '''Inlet functions, incoming assembly instructions, with global and local
    variables, built-in environment specified by __builtins__'''
    ...
    def parse_byte_and_args(self):
        ...
        #offset relative to the beginning of the bytecodes
        opoffset = f.f_lasti

        # Get the bytecode value of the instruction to be executed
        byteCode = byteint(f.f_code.co_code[opoffset])

        f.f_lasti += 1#update f_lasti

        # Use dis to analyze the name of the commmand
        byteName = dis.opname[byteCode]

        arg = None
        arguments = []

        # Judge the number of parameters, use list to storage
        if byteCode >= dis.HAVE_ARGUMENT:
            ...
            #Sequence of bytecodes that access a free variable (note that
    ...
    def dispatch(self, byteName, arguments):
        ...
        try:
            ...
            '''
            #Some functions can be directly called operator class implementation,
            #the other is implemented in the class
            if byteName.startswith('UNARY_'):
                ...
                #dispatch
                #Use getattr () function dynamically get the function
    ...
    if PY2:
        def byte_RAISE_VARARGS(self, argc):
            ...
            # There are a number of forms of "raise", normalize them
